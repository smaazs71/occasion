    ...
    <div className="relative flex items-center justify-center py-1 lg:py-0 text-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 px-4 py-2 md:py-4 rounded-md max-w-4xl mx-auto">
        ...
        <div className="grid gap-4 lg:gap-2">
          {/* {occasionName && (
            <h1 className="text-xl sm:text-2xl lg:text-4xl font-serif mb-4">
              {occasionName}
            </h1>
          )} */}
          {invitationText && (
          ...
          <div className="grid gap-2">
            <h2 className="text-lg sm:text-xl lg:text-3xl font-lora font-semibold">
              Inshallah on
            </h2>
            <p className="text-sm sm:text-lg lg:text-2xl font-lora font-normal">
            ...
            <div className="grid gap-3 lg:gap-2">
              ...
              <div className="grid gap-1">
                <p className="text-xs sm:text-sm lg:text-lg font-lora">
                  ✨ Your presence will be our greatest gift as we celebrate
                  this blessed event. ✨
                </p>
                <p className="text-xs sm:text-sm lg:text-lg font-lora overflow-auto">
